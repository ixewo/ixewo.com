...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Votre profil regorge de trésors, connectez-vous pour les trier">
    ...
    <link rel="stylesheet" type="text/css" href="../css/14-styles.css">
  ...
  <body>
    ...
    <section class="main">
      ...
      <section class="login-informations">
        ...
        <h2>Si vous faites partie de l'équipe, connectez-vous !!!</h2>

        <?php if ($message): ?>
          <p class="message"><?php echo $message; ?></p>
        <?php endif; ?>
                  
        <form class="login-section" method="post" action="connection-profil">
      ...
      <section class="register-informations">
        ...
        <h2>Vous voulez rejoindre notre équipe ?</h2>
    ...
    <script src="../js/14-script.js"></script>
