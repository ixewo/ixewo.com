...
<html lang="fr">
  ...
  <head>
    ...
    <title>Ordinateurs - ixewo</title>

    <meta name="description" content="Un produit de la catégorie Ordinateurs en vedette pour vous permettre de découvrir notre Univers !!!">
    ...
    <link rel="stylesheet" type="text/css" href="../css/30-styles.css">
  ...
  <body>
    ...
    <script src="../js/30-script.js"></script>
