...
<html lang="fr">
  ...
  <head>
    ...
    <title>Consoles - ixewo</title>

    <meta name="description" content="Un produit de la catégorie Consoles en vedette pour vous permettre de découvrir notre univers !!!">
    ...
    <link rel="stylesheet" type="text/css" href="../css/29-styles.css">
  ...
  <body>
    ...
    <script src="../js/29-script.js"></script>
