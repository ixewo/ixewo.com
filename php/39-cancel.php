<html>
  <head>
    ...
    <title>Annulation commande - ixewo</title>

    <meta name="description" content="La finalisation et le paiement ont échoués... Veuilez réessayer !!">
    ...
    <link rel="stylesheet" type="text/css" href="../css/39-styles.css">
  ...
  <body>
    ...
    <section class="main">
      ...
      <h2>Votre achat n'a pas abouti...</h2>
      <h2>Veuillez <span class="h3"> réessayez</span>.</h2>
      <h2>Si le problème persiste,<span class="h3"> contactez </span> nos équipes !!!</h2>
      ...
      <section class="activate-informations">
        ...
        <a class="vendre-but" href="favoris">Favoris</a>
