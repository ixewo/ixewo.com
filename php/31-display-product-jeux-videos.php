...
<html lang="fr">
  ...
  <head>
    ...
    <title>Jeux-Vidéo - ixewo</title>

    <meta name="description" content="Un produit de la catégorie Jeux-Vidéo en vedette pour vous permettre de découvrir notre Univers !!!">
    ...
    <link rel="stylesheet" type="text/css" href="../css/31-styles.css">
  ...
  <body>
    ...
    <script src="../js/31-script.js"></script>
