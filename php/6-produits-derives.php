<?php
  ...
  $query = "SELECT * FROM annonces  WHERE categorie = 'Produits-Dérivés'";
...
<html lang="fr">
  <head>
    ...
    <title>Accessoires de jeux vidéo d'occasion : Cartes, Figurines & bien plus - ixewo</title>

    <meta name="description" content="Découvrez notre sélection d'accessoires de jeux vidéo d'occasion : cartes, figurines, et bien plus. Élevez votre collection gaming à moindre coût">
    ...
    <link rel="stylesheet" type="text/css" href="../css/6-styles.css">
  ...
  <body>
    ...
    <section class="main">
      ...
      <section class="élevez-votre-expérience-gaming-à-moindre-coût-avec-nos-accessoires-de-qualité">
        <div class="découvrez-des-pièces-uniques-pour-enrichir-votre-collection">
          <h1 class="accessoires-de-jeux-vidéo-d-occasion-uniques">Produits Dérivés</h1>
        </div>
      </section>



      <div class="cartes-figurines-plus">
        <form class="filtres" action="produits-derives" method="get">
      ...
      <div class="découvrez-notre-sélection-d-accessoires-de-jeux-vidéo-d-occasion">
          <?php
      ...
      <div class="explorez-notre-collection-exclusive">
      ...
      <section class="cartes-figurines-objets-certifiés-signés">
        <div class="élevez-votre-collection-gaming-à-moindre-coût">
          <h1 class="accessoires-jeux-vidéo">produits dérivés</h1>
        </div>
      </section>
